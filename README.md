...
|*.NET WebRTC*|A .NET library for WebRTC, enabling real-time communication in your web applications. <br>`Angular`, `React` & `Blazor` clients.|[Browse](https://github.com/VeritasSoftware/WebRTC)|
