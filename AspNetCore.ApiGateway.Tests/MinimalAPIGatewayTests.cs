...
namespace AspNetCore.ApiGateway.Tests
{
    public class MinimalAPIInitialize
    {
        ...
        public MinimalAPIInitialize()
        {
            ...
            IWebHostBuilder gatewayAPI = new WebHostBuilder()
                                     ...
                                     .UseKestrel(options => options.Listen(IPAddress.Any, 5010, listenOptions => listenOptions.UseHttps(o => o.AllowAnyClientCertificate())));
    ...
    public class MinimalGatewayTests : IClassFixture<MinimalAPIInitialize>
    {
        readonly MinimalAPIInitialize _apiInit;

        public MinimalGatewayTests(MinimalAPIInitialize apiInit)
        {
            _apiInit = apiInit;
        }
        ...
        public async Task Test_Get_Pass()
        {
            ...
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/forecast";
        ...
        public async Task Test_Multiple_Get_Pass()
        {
            ...
            //Stock API call
            gatewayUrl = "https://localhost:5010/api/Gateway/stockservice/stocks";
        ...
        public async Task Test_Get_WithParam_Pass()
        {
            ...
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/type?parameters=3";
        ...
        public async Task Test_Post_Pass()
        {
            ...
            //Gateway API url with Api key and Route key
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/add";
        ...
        public async Task Test_Put_Pass()
        {
            ...
            //Gateway API url with Api key and Route key
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/update";
            ...
            //Gateway API url with Api key and Route key
            gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/types";
        ...
        public async Task Test_Patch_Pass()
        {
            ...
            //Gateway API url with Api key and Route key
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/patch";            
        ...
        public async Task Test_Delete_Pass()
        {
            ...
            //Gateway API url with Api key, Route key and Param
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/remove?parameters=0";
        ...
        public async Task Test_Get_Invalid_ApiKey_Fail()
        {
            ...
            var gatewayUrl = "https://localhost:5010/api/Gateway/xyzservice/forecast";
        ...
        public async Task Test_Get_Invalid_RouteKey_Fail()
        {
            ...
            var gatewayUrl = "https://localhost:5010/api/Gateway/weatherservice/xyz";
